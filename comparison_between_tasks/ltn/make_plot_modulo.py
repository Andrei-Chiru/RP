...
df = pd.read_csv(PARENT_DIR / "ltn_modulo.csv")

# Assign human-readable labels based on known run_ids from your screenshot
run_id_map = {
    "20250619T222325": "Modulo Naïve Unpoisoned ",
    "20250619T223159": "Modulo PGD Unpoisoned",
    "20250619T223331": "Modulo Naïve",
    "20250619T224315": "Modulo PGD"
}
...
# Save the plot
plt.savefig(PARENT_DIR / "ltn_modulo.png", dpi=150)
