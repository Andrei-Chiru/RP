...
def train(
    ...
    for epoch in range(epochs):
        ...
        if ds_test_sasr is not None:
            for batch_elements in ds_test_sasr:
                test_step_sasr(*batch_elements, **scheduled_parameters[epoch])
        ...
        sasr.append(metrics_dict['sasr'].result().numpy())
    ...
    return train_loss, test_loss, train_acc, clean_acc, asr,sasr